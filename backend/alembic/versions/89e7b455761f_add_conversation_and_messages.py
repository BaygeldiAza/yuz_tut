...
Revision ID: 89e7b455761f
Revises: d71217cb3f3b
Create Date: 2026-09-22 14:56:29.154249
...
revision: str = '89e7b455761f'
down_revision: Union[str, Sequence[str], None] = 'd71217cb3f3b'
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['conversation_id'], ['conversations.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
